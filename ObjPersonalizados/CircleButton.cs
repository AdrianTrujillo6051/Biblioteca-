...
namespace ObjPersonalizados
{
    public partial class CircleButton : Button
    {
        ...
        /*
         Para poder redondear perfectamente el boton necesitas introducir los mimos valores en Width, Height y BorderRadius :)
          Example:
            borderRadius = 200;
            Width = 200;
            Height = 200;

        Asi te quedara un boton redondo perfecto ;)
         */


        //Datos para diseño :)
        [Category("Redondeo properties")]
